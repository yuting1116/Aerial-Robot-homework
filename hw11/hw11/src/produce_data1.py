...
with open('/home/yuting/catkin_ws/src/hw11/src/output.csv', 'w') as csvfile:
  writer = csv.writer(csvfile)
  writer.writerow(num_list)
  writer.writerow(receve_list)

with open('/home/yuting/catkin_ws/src/hw11/src/data.csv', 'r') as csvfile:
##  reader = csv.reader(csvfile, quoting=csv.QUOTE_NONNUMERIC)
  reader = csv.reader(csvfile)
  for row in reader:
    kf_list.append(float(row[0]))
